...
const NaviBar = () => {
  ...
  return (
    <>
    <div className="fixed top-0 left-0 w-full  flex lg:space-x-4 space-x-6 lg:h-22 md:h-50 h-80 lg:w-full w-6xl items-center border-t border-b border-gray-400 shadow-lg bg-gray-300 z-50">
